...
class GroupChatController extends Controller
{
    ...
    // New: Fetch all shared files for the sidebar
    public function getGroupResources(Group $group)
    {
        $this->authorizeMember($group);
        return GroupMessage::where('group_id', $group->id)
            ->where('type', 'resource')
            ->with('resource')
            ->latest()
            ->get()
    ...
    private function authorizeMember(Group $group)
    {
